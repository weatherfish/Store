...
final class RealStore<Raw, Parsed> implements InternalStore<Parsed> {

    static final Logger LOGGER = LoggerFactory.getLogger(RealStore.class);
    ...
    public RealStore(Fetcher<Raw> fetcher,
